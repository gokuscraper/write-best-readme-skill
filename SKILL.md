...
- **Mole 式生动**:H1 标题必须配一个「生物」emoji(见硬性规则);Support 捐赠段落用**宠物投喂式措辞**(作者有宠物时):不说"支持项目/请我喝咖啡",改为"如果 X 帮到了你,可以请我的[宠物]吃[食物] 🥩",如 `如果 Mole 帮到了你,给个 star 或请我的两只猫(汤圆、可乐)吃 [罐头 🥩](链接)`;宠物种类/名字/投喂物在第 2 步问清,不编造;作者无宠物则退回轻松语气+捐赠链接;CLI 项目用终端输出代码块展示效果
- **Mole 式居中头部**:
  ```html
  <div align="center">
    <h1>🐹 Mole</h1>
...
- 宠物投喂措辞:作者是否有宠物,宠物种类/名字/投喂物(如"狗和猫、吃罐头 🥩")
- 对比表竞品(扫描识别的同行,或用户指定)
